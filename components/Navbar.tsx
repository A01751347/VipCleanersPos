// components/Navbar.tsx - Z-index corregido para compatibilidad con modales
"use client"
...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Main Navigation - Z-INDEX CORREGIDO */}
      <MainNavbar 
        scrolled={scrolled}
...
// Main navbar component - Z-INDEX CORREGIDO
const MainNavbar: React.FC<{
  ...
  // Z-INDEX REDUCIDO para permitir que modales aparezcan encima
  const navbarClasses = `fixed top-0 left-0 w-full px-4 sm:px-6 lg:px-8 py-4 transition-all duration-300 ${
  ...
  return (
    <nav 
      ...
      style={{ zIndex: 40 }} // Reducido de z-50 (50) a z-40 (40) para estar por debajo de modales
    >
...
// Mobile menu component - Z-INDEX CORREGIDO
const MobileMenu: React.FC<{
  ...
  <div 
    ...
    style={{ zIndex: 45 }} // Z-index entre navbar (40) y modales (9999), pero por debajo de modales
  >
