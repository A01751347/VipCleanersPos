      ...
      >
        ...
        >
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/60 focus:bg-white/20 focus:border-white/40 transition-all"
                  />
                </div>
                <button
                  onClick={onClose}
          ...
          <div className="flex-1 p-6 grid grid-cols-1 lg:grid-cols-2 gap-6 overflow-hidden">
                        ...
                        <div key={idx} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <select
                              ...
                              className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#78f3d3]"
                            >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2 max-h-72 overflow-y-auto bg-white border border-gray-200 rounded-lg p-3">
                      {[
            ...
            {/* Right side - Summary */}
            <div className="bg-gray-50 rounded-xl p-6 flex flex-col min-w-80">
              ...
              {/* Customer info */}
              <div className="space-y-2 mb-6 text-sm bg-white rounded-lg p-4">
                <h4 className="font-medium text-gray-900 mb-2">Información de contacto</h4>
                <div className="flex items-center">
                  <User size={14} className="mr-2 text-gray-500" />
                  <span>{formData.fullName || "Ingresa tu nombre"}</span>
                </div>
                <div className="flex items-center">
                  <Mail size={14} className="mr-2 text-gray-500" />
                  <span>{formData.email || "Ingresa tu email"}</span>
                </div>
                <div className="flex items-center">
                  <Phone size={14} className="mr-2 text-gray-500" />
                  <span>{formData.phone || "Ingresa tu teléfono"}</span>
                </div>
                {(formData.bookingDate || formData.bookingTime) && (
                  <div className="flex items-center">
                    <Calendar size={14} className="mr-2 text-gray-500" />
                    <span>
                      {formData.bookingDate ? new Date(formData.bookingDate).toLocaleDateString('es-ES', { 
                        weekday: 'short', 
                        day: 'numeric', 
                        month: 'short' 
                      }) : 'Fecha'} 
                      {formData.bookingTime ? ` a las ${formData.bookingTime}` : ''}
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="mt-auto">
                ...
                {formStatus.status === "success" && (
                  <div className="mt-4 text-center p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <h4 className="font-bold text-[#313D52] mb-2">¡Reserva Confirmada!</h4>
                    <p className="text-sm text-gray-600 mb-2">Referencia:</p>
                    <div className="bg-white p-2 rounded border">
                      <span className="font-bold text-[#313D52]">{formStatus.bookingReference}</span>
                    </div>
                  </div>
                )}
              </div>
